                ...
                <form class="form-horizontal" method="POST" id="payment-form" role="form" action="{!!route('addmoney.stripe')!!}" >
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-xs-4 form-group expiration required">
                            ...
                            <input class="form-control card-expiry-year" placeholder="YYYY" size="4" type="4" name="ccExpiryYear">
                            <input class="form-control card-expiry-year" placeholder="YYYY" size="4" type="4" name="amount" value="300">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-12">
