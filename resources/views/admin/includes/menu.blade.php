<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-cubes fa-fw"></i> Category Info<span class="fa arrow"></span></a>
            ...
            <li>
                <a href="#"><i class="fa fa-star fa-fw"></i> Brands <span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
                <a href="#"><i class="fa fa-cube fa-fw"></i>Product Info<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
