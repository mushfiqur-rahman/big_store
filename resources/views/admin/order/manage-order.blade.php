                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $order->customer? $order->customer->first()->first_name.' '.$order->customer->first()->last_name:"" }}</td>
                                <td>{{ $order->order_total }}</td>
                                <td>{{ $order->created_at }}</td>
                                <td>{{ $order->order_status }}</td>
                                <td>{{ $order->payments->first()->payment_type }}</td>
                                <td>{{ $order->payments->first()->payment_status }}</td>
                                <td>
                                    ...
                                    <a href="{{ route('delete-order', ['id'=>$order->id]) }}" class="btn btn-danger btn-xs" title="Delete Order">
